function footer() {
    ...
    const buttonlinks = ['Politca De Privacidade', 'Termos De Uso', 'Vendas']
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="border-t border-gray-800 pt-6 ">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-xl text-gray-500">Copyright © 2026 Apple Inc. Todos Os Direitos Reservados.</p>
                    ...
                    <p className="text-xs text-gray-500 mt-6">Site Criado Somente Para Estudos E Aprendizados</p>
                </div>
